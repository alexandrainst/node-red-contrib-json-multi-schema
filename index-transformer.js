...
"use strict";
/**
 * Command-line interface for the json-multi-schema-transformer Node-RED module.
 * 
...
RED.nodes.config.transformsUrl = args ? args[0] : '';
//TODO: Allow passing directy the transform data

//Load our Node-RED module
const noderedModule = require('./json-multi-schema-transformer.js');
noderedModule(RED);
